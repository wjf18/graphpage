...
from geoseg.losses.Loss import ModelLoss
...
train_dataset = PotsdamDataset(data_root='GeoSeg\data/potsdam/train', mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(transform=val_aug)
test_dataset = PotsdamDataset(data_root='GeoSeg\data/potsdam/test',
                              transform=val_aug)
