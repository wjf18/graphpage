...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="data_0/uavid/uavid_train_val")
    parser.add_argument("--output-img-dir", default="data_0/uavid/train_val/images")
    parser.add_argument("--output-mask-dir", default="data_0/uavid/train_val/masks")
