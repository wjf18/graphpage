...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data1/potsdam/train_images")
    parser.add_argument("--mask-dir", default="data1/potsdam/train_masks")
    parser.add_argument("--output-img-dir", default="data1/potsdam/train/images_1024")
    parser.add_argument("--output-mask-dir", default="data1/potsdam/train/masks_1024")
