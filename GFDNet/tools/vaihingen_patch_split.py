...
ImSurf = np.array([255, 255, 255])  # label 0, 不变
Building = np.array([0, 0, 255])    # label 1, 修正为蓝色
LowVeg = np.array([0, 255, 255])   # label 2, 修正为青色
Tree = np.array([0, 255, 0])      # label 3, 不变
Car = np.array([255, 204, 0])      # label 4, 修正为橙/黄色
Clutter = np.array([255, 0, 0])    # label 5, 修正为红色
